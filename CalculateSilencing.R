...
for(chrs in c('chr1','chr2','chr3','chr4','chr5','chr6','chr7','chr8','chr9','chr10','chr11','chr12','chr13','chr14','chr15','chr16','chr17','chr18','chr19')){
	print(chrs)
	print(median(transcriptome_ss[transcriptome_ss$V1==chrs,]$Cmp_data_ss_x))
	print(median(transcriptome_ss[transcriptome_ss$V1==chrs,]$Cmp_data_ss_y))
}

D <- transcriptome_ss[transcriptome_ss$V1 =="chr3", ]

D$site = ceiling(D$V2/10000000)
library(ggplot2)
